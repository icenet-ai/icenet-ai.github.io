...
<figure>
  <img src="~/assets/images/posts/may25-publication-caribou-paper/graphical-abstract.png" alt="An overview of the IceNet caribou migration prediction system" />
...
<figure>
  <video controls width="640">
    <source src="~/assets/images/posts/may25-publication-caribou-paper/GPS collared caribou migrating across sea ice.mp4" type="video/mp4" />
  </video>
...
<figure>
  <img src="~assets\images\posts\may25-publication-caribou-paper\A small cabin on a frozen lake on the south coast of the Victoria Islands (Credit Terry Milton + Government of Nunavut).jpg" alt="A small cabin on a frozen lake on the south coast of the Victoria Islands (Credit Terry Milton + Government of Nunavut)" />
