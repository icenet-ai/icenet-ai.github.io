...
excerpt: "[Paper] We use IceNet to predict sea ice migration times for an endangered caribou population, opening doors for more adaptive conservation..."
...
import imgOverview from '~/assets/images/posts/may25-publication-caribou-paper/graphical-abstract.png';
import imgCabin from '~/assets/images/posts/may25-publication-caribou-paper/A small cabin on a frozen lake on the south coast of the Victoria Islands (Credit Terry Milton + Government of Nunavut).jpg';



<div class="text-center italic text-gray-500 dark:text-gray-500 mt-[-0.25rem] mb-4">
...
<figure>
  <Image src={imgOverview} alt="An overview of the IceNet caribou migration prediction system" />
  <figcaption>An overview of the IceNet caribou migration prediction system.</figcaption>
</figure>
...
<figure>
    <video width="100%" controls loop autoplay>
        <source src="posts/may25-publication-caribou-paper/GPS collared caribou migrating across sea ice.mp4" type="video/mp4" />
    </video>
    <figcaption>Animation showing Dolphin and Union caribou gathering on the south coast of Victoria Island, waiting for sea ice to form before continuing their autumn migration south.</figcaption>
</figure>
...
<figure>
  <Image src={imgCabin} alt="A small cabin on a frozen lake on the south coast of the Victoria Islands (Credit Terry Milton + Government of Nunavut)" />
  <figcaption>A small cabin on a frozen lake on the south coast of the Victoria Islands (Credit Terry Milton + Government of Nunavut).</figcaption>
</figure>



## Details
Hear more from the team and partners in the [BAS news story](https://www.bas.ac.uk/media-post/new-ai-tool-aids-caribou-conservation-in-a-changing-arctic/)!
